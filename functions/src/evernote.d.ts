...
declare module 'evernote' {
  ...
  interface Callback<T> {
    (err: Errors.EDAMUserException | Errors.EDAMSystemException | Errors.EDAMNotFoundException, v: T): void
  }
  ...
  class NoteStoreClient {
     ...
     */
    listTags(cb: Callback<Types.Tag[]>): void;
     ...
     * </ul>
     */
    listTagsByNotebook(notebookGuid: string, cb: Callback<Types.Tag[]>): void;
     ...
     * </ul>
     */
    getTag(guid: string, cb: Callback<Types.Tag>): void;
     ...
     * </ul>
     */
    createTag(tag: Types.Tag, cb: Callback<Types.Tag>): void;
     ...
     * </ul>
     */
    updateTag(tag: Types.Tag, cb: Callback<number>): void;
     ...
     * </ul>
     */
    getNote(guid: string, withContent: boolean, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean, cb: Callback<Types.Note>): void;
     ...
     */
    getNoteApplicationData(guid: string, cb: Callback<Types.LazyMap>): void;
     ...
     * </ul>
     */
    updateNote(note: Types.Note, cb: Callback<Types.Note>): void;
     ...
     * </ul>
     */
    copyNote(noteGuid: string, toNotebookGuid: string, cb: Callback<Types.Note>): void;
     ...
     * </ul>
     */
    getNoteVersion(noteGuid: string, updateSequenceNum: number, withResourcesData: boolean, withResourcesRecognition: boolean, withResourcesAlternateData: boolean, cb: Callback<Types.Note>): void;
     ...
     * </ul>
     */
    getResource(guid: string, withData: boolean, withRecognition: boolean, withAttributes: boolean, withAlternateData: boolean, cb: Callback<Types.Resource>): void;
     ...
     */
    getResourceApplicationData(guid: string, cb: Callback<Types.LazyMap>): void;
     ...
     * </ul>
     */
    updateResource(resource: Types.Resource, cb: Callback<number>): void;
     ...
     * </ul>
     */
    getResourceByHash(noteGuid: string, contentHash: string, withData: boolean, withRecognition: boolean, withAlternateData: boolean, cb: Callback<Types.Resource>): void;
     ...
     * </ul>
     */
    getResourceAttributes(guid: string, cb: Callback<Types.ResourceAttributes>): void;
  ...
  class SyncChunk {
    ...
    constructor(args?: { currentTime: number; chunkHighUSN?: number; updateCount: number; notes?: Types.Note[]; notebooks?: Notebook[]; tags?: Types.Tag[]; searches?: SavedSearch[]; resources?: Types.Resource[]; expungedNotes?: string[]; expungedNotebooks?: string[]; expungedTags?: string[]; expungedSearches?: string[]; linkedNotebooks?: LinkedNotebook[]; expungedLinkedNotebooks?: string[]; });
  }
  ...
  class NoteList {
    ...
    constructor(args?: { startIndex: number; totalNotes: number; notes: Types.Note[]; stoppedWords?: string[]; searchedWords?: string[]; updateCount?: number; });
  }
  ...
  class NoteEmailParameters {
    ...
    constructor(args?: { guid?: string; note?: Types.Note; toAddresses?: string[]; ccAddresses?: string[]; subject?: string; message?: string; });
  }
  ...
  class RelatedResult {
    ...
    constructor(args?: { notes?: Types.Note[]; notebooks?: Notebook[]; tags?: Types.Tag[]; containingNotebooks?: NotebookDescriptor[]; });
  }
